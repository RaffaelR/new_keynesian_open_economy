...
%Eqn 49: Welfare
WF= (1/2)*(C^(1-sigma_c)*Epsi_c^(sigma_c)/(1-sigma_c)+G^(1-sigma_c)/(1-sigma_c)-N^(1+sigma_n)/(1+sigma_n)+C_star^(1-sigma_c)*Epsi_c_star^(sigma_c)/(1-sigma_c)+G_star^(1-sigma_c)/(1-sigma_c)-N_star^(1+sigma_n)/(1+sigma_n))+betta*WF(+1);
end;
...
WF=(1/(1-betta))*(1/2)*(C^(1-sigma_c)*Epsi_c^(sigma_c)/(1-sigma_c)+G^(1-sigma_c)/(1-sigma_c)-N^(1+sigma_n)/(1+sigma_n)+C_star^(1-sigma_c)*Epsi_c_star^(sigma_c)/(1-sigma_c)+G_star^(1-sigma_c)/(1-sigma_c)-N_star^(1+sigma_n)/(1+sigma_n));
end;
