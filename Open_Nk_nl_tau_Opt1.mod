...
%Eqn 51: Welfare
WF1= C^(1-sigma_c)*Epsi_c^(sigma_c)/(1-sigma_c)+G^(1-sigma_c)/(1-sigma_c)-N^(1+sigma_n)/(1+sigma_n)+betta*WF1(+1);
...
WF1= (1/(1-betta))*(C^(1-sigma_c)*Epsi_c^(sigma_c)/(1-sigma_c)+G^(1-sigma_c)/(1-sigma_c)-N^(1+sigma_n)/(1+sigma_n));
end;
